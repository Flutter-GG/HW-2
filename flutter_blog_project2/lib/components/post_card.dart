...
import 'package:flutter_blog_project2/screens/post_info_screen.dart';

class PostCard extends StatefulWidget {
  const PostCard({super.key, required this.post, required this.buttonIcon, required this.iconFunction});
