...
class Space {
  ...
  static SizedBox spaceH64 = const SizedBox(
    width: 64,
  );
    static SizedBox spaceH100 = const SizedBox(
    height: 100,
  );
  static SizedBox spaceH200 = const SizedBox(
    width: 200,
  );
  ...
  static SizedBox spaceW32 = const SizedBox(
   ...
   static SizedBox spaceW100 = const SizedBox(
    width: 100,
  );
   static SizedBox spaceW200 = const SizedBox(
    width: 200,
  );
}